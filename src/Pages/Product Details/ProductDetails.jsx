...
import { Button, Grid, LinearProgress, Rating, Typography, Box } from "@mui/material";
import { ProductReview } from "./ProductReview";
import Product from './../Products/Product';
import { HomeCorousel } from "../Home/HomeCorousel";
    ...
    <div className="bg-white">
      <div className="pt-6">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item, ind) => (
                <div
                  ...
                  className="aspect-h-2 cursor-pointer aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4 "
                >
                  <img
                    src={item.src}
                    alt={item.alt}
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0 text-left">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm ">5829 Ratings</p>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className=" opacity-60">3790 Ratings</p>
                </div>
                <Box className="mt-5 text-left space-y-3">
                  <Grid container alignItems="center" gap={2}>
                    <Grid items xs={2} className=" mr-3">
                      <p>Excellent</p>
                    </Grid>
                    <Grid items xs={7}>
                      <LinearProgress
        ...
        <section className="pt-10">
          <HomeCorousel data={data} sectionName={"Similer Products"} />
          <HomeCorousel data={data} sectionName={""} />
          <HomeCorousel data={data} sectionName={""} />
